...
<p align="center">
<img src="../../../../imagens/list-interface-hierarchy.png" alt="List interface hierarchy Java"><br>
...
<p>Crie uma classe chamada "main.java.list.OperacoesBasicas.CarrinhoDeCompras" que representa um carrinho de compras online. O carrinho deve ser implementado como uma lista de itens. Cada item é representado por uma classe chamada "Item" que possui atributos como nome, preço e quantidade. Implemente os seguintes métodos:
